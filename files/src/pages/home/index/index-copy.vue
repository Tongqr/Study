    ...
    <div class="index-main">
        ...
        <div class="menu-wrap">
            <div class="menu" v-for="(item,index) in navs" :key="index">
                <div class="menu-img"><a><img src="../../../assets/images/common/lazyImg.jpg" :data-echo="item.image"></a></div>
        ...
        <div class="classify-wrap">
            <template v-for="(item,index) in goods">
                <div class="goods-classify goods-women" :key="index" v-if="(index+1)%2==1">
                    ...
                    <div class="goods-row1">
                        ...
                        <div class="goodsRight">
                            <div class="rightgoods1" v-for="(item2,index2) in item.items.slice(1,3)" :key="index2">
                    ...
                    <div class="goods-row2">
                        <div class="goodslist" v-for="(item2,index2) in item.items.slice(3)" :key="index2">
                ...
                <div class="goods-classify goods-men" v-else :key="index">
                    ...
                    <div class="goods-row1">
                        <div class="goodsLeft men"  v-for="(item2,index2) in item.items.slice(0,2)" :key="index2">
                            <div class="leftgoods">
...
<style scoped>
    ...
    .menu-wrap{width:100%;height:1.4rem;background:#fff;color:#323232;font-size: 0.28rem;display: flex;padding-top:0.2rem;
        text-align: center;}
    .menu-wrap .menu{width:1.4rem;height:1.2rem;background:#fcc;margin-right:2%;}
